        ...
        <div class="card-body">
          ...
          <form class="form-lazy-control" data-action="{{ $action }}" data-validate="password">
            ...
            <div class="form-group">
              ...
              <input type="password" name="new_password" id="new_password" class="form-control form-control-sm" placeholder="{{ __('Password') }}" required>
            </div>
            <div class="form-group">
              <label>{{ __('Confirm Password') }}</label>
              <input type="password" name="confirm_password" class="form-control form-control-sm" placeholder="{{ __('Re-Type Password') }}" required>
            </div>
