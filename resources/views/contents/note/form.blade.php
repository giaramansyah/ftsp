                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <select class="form-control form-control-sm select2" name="year"
                                {{ isset($mandatory) && $mandatory ? 'required' : '' }} onchange="getData();">
                                <option value="">-- Silakan Pilih --</option>
                                @foreach ($yearArr as $key => $value)
                                    <option value="{{ $value['id'] }}"
                                        {{ isset($year) && $year == $value['id'] ? 'selected' : '' }}>{{ $value['name'] }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-sm-2">
                            <select class="form-control form-control-sm select2" name="division_id"
                                ...
                                @foreach ($divisionArr as $key => $value)
                                    <option value="{{ $value['id'] }}"
                                        {{ isset($division_id) && $division_id == $value['id'] ? 'selected' : '' }}>
                                        {{ $value['name'] }}</option>
                                @endforeach
                            </select>
                        </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="staff_id"
                                                            value="{{ $value['id'] }}"
                                                            {{ isset($staff_id) && in_array($value['id'], $staff_id) ? 'checked' : '' }}
                                                            {{ isset($mandatory) && $mandatory && $key == 1 ? 'required' : '' }}>
                    ...
                    <div class="form-group row form-staff-input-1">
                        ...
                        <div class="col-sm-2">
                            ...
                            <input type="text" class="form-control form-control-sm" name="staff"
                                value="{{ config('global.staff.desc.kaprodis1') }}" readonly
                                {{ isset($mandatory) && $mandatory && $key == 0 ? 'required' : '' }}>
                        </div>
                    </div>
                    <div class="form-group row form-staff-input-2">
                        ...
                        <div class="col-sm-2">
                            ...
                            <input type="text" class="form-control form-control-sm" name="staff"
                                value="{{ config('global.staff.desc.kaprodis2') }}" readonly
                                {{ isset($mandatory) && $mandatory && $key == 0 ? 'required' : '' }}>
                        </div>
                    </div>
                    @if (!isset($id))
                        ...
                        <div class="col-sm-2">
                            <div class="input-group input-group-sm">
                                ...
                                <input type="text" class="form-control form-control-sm text-right" maxlength="20"
                                    name="amount" id="validate_max_request" onkeypress="preventAlpha(event)" onkeyup="numberFormat(this, true)"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control form-control-sm" name="note_reff"
                                value="{{ isset($note_reff) ? $note_reff : '' }}"
                                {{ isset($mandatory) && $mandatory ? 'required' : '' }}>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="date" class="form-control form-control-sm" name="note_date"
                                value="{{ isset($note_date) ? $note_date : '' }}"
                                {{ isset($mandatory) && $mandatory ? 'required' : '' }}>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="date" class="form-control form-control-sm" name="note_upload"
                                value="{{ isset($note_upload) ? $note_upload : '' }}"
                                {{ isset($mandatory) && $mandatory ? 'required' : '' }}>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control form-control-sm" maxlength="200" name="regarding"
                                value="{{ isset($regarding) ? $regarding : '' }}"
                                {{ isset($mandatory) && $mandatory ? 'required' : '' }}>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <div class="input-group input-group-sm">
                                ...
                                <input type="text" class="form-control form-control-sm text-right" maxlength="20"
                                    name="amount_requested" id="validate_max_approve" onkeypress="preventAlpha(event)"
                                    onkeyup="numberFormat(this, true)"
                    ...
                    @if (isset($status) && $status == config('global.status.code.finished'))
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="text" class="form-control form-control-sm text-right" maxlength="20"
                                        name="amount_approved" onkeypress="preventAlpha(event)"
                                        onkeyup="numberFormat(this, true)"
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Terbilang<code>*</code></label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control form-control-sm" id="text_amount_approve"
                                    readonly>
                            </div>
                        </div>
                    @endif
