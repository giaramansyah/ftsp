    ...
    <div class="container-fluid">
        <div class="card">
            <form class="form-lazy-control" data-action="{{ $action }}" data-method="upload"
                data-validate="max_amount,image">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="hidden" name="division_id"
                                value="{{ isset($data['division_id']) && $data['division_id'] ? $data['division_id'] : '' }}">
                            <input type="text" class="form-control form-control-sm"
                                value="{{ isset($data['division']) && $data['division'] ? $data['division'] : '' }}"
                                readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control form-control-sm" name="expense_id"
                                value="{{ isset($expense_id) ? $expense_id : '' }}" readonly
                        ...
                        <div class="col-sm-2">
                            <input type="date" class="form-control form-control-sm" name="expense_date"
                                value="{{ isset($expense_date) ? $expense_date : '' }}"
                                {{ isset($mandatory) && $mandatory ? 'required' : '' }}>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="date" class="form-control form-control-sm" name="reff_date"
                                value="{{ isset($reff_date) ? $reff_date : '' }}"
                                {{ isset($mandatory) && $mandatory ? 'required' : '' }}>
                        </div>
                    </div>
                    <div class="form-group row mb-0">
                        ...
                        <div class="col-sm-2">
                            ...
                            <input type="text" class="form-control form-control-sm" name="ma_id"
                                value="{{ isset($ma_id) ? $ma_id : '' }}" readonly
                                {{ isset($mandatory) && $mandatory ? 'required' : '' }}>
                        </div>
                        <div class="col-sm-2">
                            <div class="form-check pt-2">
                                <input class="form-check-input" type="checkbox" name="edt_ma_id" value="1"
                                    onchange="editMa()">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control form-control-sm" maxlength="350" name="description"
                                value="{{ isset($description) && $description ? $description : '' }}"
                                {{ isset($mandatory) && $mandatory ? 'required' : '' }}>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <textarea class="form-control form-control-sm" name="sub_description" maxlength="350" rows="4">{{ isset($sub_description) ? $sub_description : '' }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                            ...
                            <select class="form-control form-control-sm select2" name="name"
                                ...
                                @foreach ($employeeArr as $key => $value)
                                    <option value="{{ $value['id'] }}"
                                        {{ isset($name) && $name == $value['id'] ? 'selected' : '' }}>{{ $value['name'] }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-sm-2">
                            <select class="form-control form-control-sm select2" name="staff_id"
                                {{ isset($mandatory) && $mandatory ? 'required' : '' }}>
                                <option value="">-- Silakan Pilih --</option>
                                @foreach ($staffArr as $value)
                                    <option value="{{ $value['id'] }}"
                                        {{ isset($staff_id) && $staff_id == $value['id'] ? 'selected' : '' }}>
                                        {{ $value['name'] }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <div class="input-group input-group-sm">
                                ...
                                <input type="text" class="form-control form-control-sm text-right" maxlength="20"
                                    name="amount" value="{{ isset($amount) && $amount ? $amount : '' }}"
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control form-control-sm" maxlength="20" name="account"
                                value="{{ isset($account) && $account ? $account : '' }}"
                                onkeypress="preventAlpha(event)" onkeyup="numberFormat(this, false)"
                                onblur="numberFormat(this, false)"
                                {{ isset($mandatory) && $mandatory ? 'required' : '' }}>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control form-control-sm" name="text_amount"
                                id="text_amount" value="{{ isset($text_amount) && $text_amount ? $text_amount : '' }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                @if (isset($image) && $image)
                                    ...
                                    @else
                                        <i class="fas fa-exclamation-circle text-danger" title="File Not Found"></i><span
                                            class="text-muted">
                                            {{ $image }}
                                        </span>
                                    @endif
                                ...
                                <div class="input-group input-group-sm">
                                    <div class="custom-file">
                                        <input type="file" name="image" id="image" class="custom-file-input"
                                            ...
                                            {{ isset($mandatory) && $mandatory && !isset($image) ? 'required' : '' }}>
                    ...
                    @else
                        <div class="form-group row">
                            <label
                                class="offset-sm-2 col-sm-10 col-form-label text-danger font-italic font-weight-normal">catatan
                                : upload file LPJ jika ingin merubah status menjadi bon merah (selesai), jika tidak
                                kosongkan</label>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Tgl. Penyerahan<code>*</code></label>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-sm-1">
                                @include('partials.button.back', [
                                    ...
                                    'action' => route('transaction.expense.index'),
                                ])
                            </div>
                            <div class="col-sm-1">
