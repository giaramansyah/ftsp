<div class="modal fade" id="modalPrintRed">
    ...
    <div class="modal-content">
      <form class="form-lazy-control" data-action="{{ $modal_action }}">
        ...
        <div class="modal-body p-2">
          <input type="hidden" name="type" value="{{ config('global.type.code.red') }}">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <select class="form-control form-control-sm select2" name="sender">
                <option value="">-- Silakan Pilih --</option>
                @foreach ($employeeArr as $key => $value)
                <option value="{{ $value['id'] }}">{{
                  $value['name'] }}</option>
