 ...
 (function () {
    ...
    if ("undefined" === typeof Chart) console.error("Can not find Chart object.");
       ...
       f.prototype.renderArcLabel = function (a, c) {
          ...
          } else b.rotate((d.startAngle + Math.PI / 2 + c.endAngle) / 2), b.translate(0, -1 * e), this.renderLabel(a, { x: 0, y: 0 });
          b.restore();
       };
       ...
       f.prototype.getFontColor = function (a, c, b) {
          ...
          "function" === typeof e
             ? (e = e({ label: this.chart.config.data.labels[b], value: a.data[b], percentage: this.getPercentage(a, c, b), backgroundColor: a.backgroundColor[b], dataset: a, index: b }))
       ...
       f.prototype.getPercentage = function (a, c, b) {
          ...
          this.options.showActualPercentages ||
             ("bar" === this.chart.config.type && (this.totalPercentage = this.barTotalPercentage[b] || 0),
             (this.totalPercentage += a),
             100 < this.totalPercentage && ((a -= this.totalPercentage - 100), (a = parseFloat(a.toFixed(this.options.precision)))),
             "bar" === this.chart.config.type && (this.barTotalPercentage[b] = this.totalPercentage));
